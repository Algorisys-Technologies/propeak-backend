...
router.post(
  "/getAllLeaves/",
  verifyToken,
  leaveApplication_controller.getAllLeaves
);
...
router.get(
  "/getDetails/:leaveId",
  verifyToken,
  leaveApplication_controller.getDetails
);
...
router.post(
  "/approveReject/",
  verifyToken,
  leaveApplication_controller.approveReject
);
...
router.post(
  "/deleteLeave/",
  verifyToken,
  leaveApplication_controller.deleteLeave
);
...
router.post(
  "/approveLeave/",
  verifyToken,
  leaveApplication_controller.approveLeave
);
...
router.get(
  "/getHolidays/",
  verifyToken,
  leaveApplication_controller.getHolidays
);
...
router.post(
  "/checkEligibility/",
  verifyToken,
  leaveApplication_controller.CheckForBalanceLeaves
);
...
router.get(
  ...
  verifyToken,
  checkRole,
  leaveApplication_controller.getAllAppliedLeavesforAdmin
);

router.post(
  "/getUserOnLeaveDetails/",
  verifyToken,
  leaveApplication_controller.getUserOnLeaveDetails
);
